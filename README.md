...
### Usage Instructions:
1. [Download](https://github.com/Tech-How/maniaplanet-scripts/blob/main/Download%20Map%20Dependencies.ps1) and save `Download Map Dependencies.ps1` somewhere.
...
### Usage Instructions:
1. [Download](https://github.com/Tech-How/maniaplanet-scripts/blob/main/Upgrade%20Maps%20to%20MP4.cmd) and save `Upgrade Maps to MP4.cmd` somewhere.
